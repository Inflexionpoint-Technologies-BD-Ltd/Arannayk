...
<body data-rsssl="1"
    ...
    <div class="body-wrapper float-menu" data-home="https://demo.goodlayers.com/greennature/">
                                        ...
                                        @foreach ($sliders as $slider)
                                            @if ($slider->serial == 1)
                                                <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                                    ...
                                                    @if ($loop->first)
                                                        <a href="{{ route('projects') }}" target="_self"
                                                            ...
                                                            data-duration="400" data-delay="987"
                                                            data-ease="easeOutQuint" data-type="button"
                                                    ...
                                                    <div class="ms-layer msp-cn-1-3"
                                                        ...
                                                        data-offset-x="0" data-offset-y="105" data-origin="ml"
                                                    ...
                                                    <div class="ms-layer msp-cn-1-2"
                                                        ...
                                                        data-offset-x="0" data-offset-y="-5" data-origin="ml"
                                                        data-position="normal">
                                                    ...
                                                    <div class="ms-layer msp-cn-1-1"
                                                        style="margin-top:30px; !important;"
                                                        data-effect="t(true,150,n,n,n,n,n,n,n,n,n,n,n,n,n)"
                                                        data-duration="350" data-ease="easeOutQuint"
                                                        data-offset-x="0" data-offset-y="-100" data-origin="ml"
                                                        data-position="normal">
                                                ...
                                                <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                                    ...
                                                    @if ($loop->first)
                                                        <a href="{{ route('projects') }}" target="_self"
                                                            ...
                                                            data-duration="400" data-delay="987"
                                                            data-ease="easeOutQuint" data-type="button"
                                                            data-offset-x="1" data-offset-y="227" data-origin="ml"
                                                            data-position="normal">Learn More</a>
                                                    @else
                                                    ...
                                                    <div class="ms-layer msp-cn-1-9"
                                                        ...
                                                        data-effect="t(true,150,n,n,n,n,n,n,n,n,n,n,n,n,n)"
                                                        data-duration="437" data-delay="625" data-ease="easeOutQuint"
                                                        data-offset-x="0" data-offset-y="139" data-origin="ml"
                                                        data-position="normal">
                                                        {!! $slider->text_content_2 !!}
                                                    </div>
                                                    ...
                                                    <div class="ms-layer msp-cn-1-5"
                                                        data-effect="t(true,150,n,n,n,n,n,n,n,n,n,n,n,n,n)"
                                                        data-duration="350" data-ease="easeOutQuint"
                                                        data-offset-x="0" data-offset-y="52" data-origin="ml"
                                                        data-position="normal">
                                                        {!! $slider->text_content_1 !!}
                                                    </div>
                                                </div>
                ...
                ">
                                    ...
                                    <div class="greennature-ux column-service-ux achievements-card">
                                        <div class="greennature-item greennature-column-service-item greennature-type-2"
                                            ...
                                            <div class="column-service-image">
                                                <img src="{{ asset('upload/icon-service-1.png') }}" alt=""
                                                    width="80" height="80" />
                                            </div>
                                            <div class="column-service-content-wrapper">
                                                ...
                                                <a class="column-service-read-more"
                                                    href="{{ route('aboutUs') }}">Learn
                                                    More</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="four columns reveal fade-bottom">
                                    <div class="greennature-ux column-service-ux">
                                        <div class="greennature-item greennature-column-service-item greennature-type-2-bg mission-card"
                                            style="margin-bottom: 0px">
                                            <div class="column-service-image">
                                                <img src="{{ asset('upload/pngwing.com.png') }}" alt=""
                                                    width="80" height="80" />
                                            </div>
                                            <div class="column-service-content-wrapper">
                                                <h3 class="column-service-title">
                                ...
                                <div class="four columns reveal fade-bottom">
                                    <div class="greennature-ux column-service-ux achievements-card">
                                        <div class="greennature-item greennature-column-service-item greennature-type-2"
                                            style="margin-bottom: 0px">
                                            <div class="column-service-image">
                                                <img src="{{ asset('upload/toppng.com-award-icon-2-white-icon-357x488.png') }}"
                                                    style="height:50px;" alt="" width="80"
                                                    height="80" />
                                            </div>
                                            <div class="column-service-content-wrapper">
                                    ...
                                    <div class="six columns service-style reveal fade-left">
                                        <div class="greennature-item greennature-action-ads-item"
                                            ...
                                            <a href="/services" class="services-title-style">
                                                <h3 class="action-ads-title"
                                                    style="color: {{ $service->color_title }}">
                    ...
                    <section id="content-section-1">
                        <div class="greennature-color-wrapper  gdlr-show-all no-skin"
                            style="background-color: #ffffff; padding-top: 75px; padding-bottom: 5px; ">
                            <div class="container">
                                <div class="greennature-testimonial-item-wrapper" style="margin-bottom: 80px;">
                                    <div
                                        class="greennature-item-title-wrapper greennature-item  greennature-nav-container greennature-left greennature-small ">
                                        <div
                                            ...
                                            <div class="greennature-item-title-container container">
                                                <div class="greennature-item-title-head">
                                                    <h3
                                                        ...
                                                        <img src="{{ asset('upload/icon-5.png') }}" alt=""
                                                            width="80" height="80" />Our
                                                        Recent Projects
                                                    </h3>
                                                    <span class="greennature-nav-title"><i
                                    ...
                                    <div class="greennature-item greennature-testimonial-item carousel round-style">
                                        <div class="greennature-ux greennature-testimonial-ux">
                                            <div class="flexslider" data-type="carousel"
                                                data-nav-container="greennature-testimonial-item" data-columns="3">
                                                <ul class="slides">
                                                    @foreach ($projects as $project)
                                                        <li class="testimonial-item">
                                                            <div class="testimonial-item-inner greennature-skin-box">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="portfolio-classic-content">
                                                                            <h5 class="portfolio-title"
                                                                                ...
                                                                                <a
                                                                                    href="{{ route('viewCurrentProject', $project->id) }}">{{ \Illuminate\Support\Str::words($project->title, 13, '...') }}</a>
                                                                            </h5>
                                                                            <div class="greennature-portfolio-info">
                                                                                <div
                                                                                    class="portfolio-info portfolio-tag">
                                                                                    <span
                                                                                        class="info-head greennature-title">
                                                                                    </span>
                                                                                    <p>
                                                                                        {{ $project->location }}
                                                                                    </p>
                                                                            ...
                                                                            <div class="portfolio-excerpt">
                                                                                ...
                                                                                <div class="clear"></div>
                                                                                <a href="{{ route('viewCurrentProject', $project->id) }}"
        ...
        {{--                                            Recent Projects --}}
        {{--                                        </h3> --}}
        {{--                                        <a class="greennature-item-title-link" style="font-size:15px;" --}}
        {{--                                           href="{{ route('projects') }}">More --}}
        {{--                                            Projects</a> --}}
        {{--                                        <div class="clear"></div> --}}
        {{--                                    </div> --}}
        {{--                                </div> --}}
        ...
        <section id="content-section-4">
            <div class="" style="background-color: #ffffff; padding-bottom: 25px">
                <div class="container">
                    <div
                        class="greennature-item-title-wrapper greennature-item greennature-left-divider greennature-medium">
                        <div class="greennature-item-title-container container">
                            <div class="greennature-item-title-head">
                                ...
                                <a class="greennature-item-title-link" style="font-size:15px;"
                                    href="{{ route('timeline') }}">View Full Timeline
                                </a>
                                <div class="clear"></div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="greennature-item-title-wrapper greennature-item greennature-left-divider greennature-medium"
                        ...
                        <div class="greennature-item-title-container container">
                            <div class="greennature-item-title-head">
                                <h3 class="greennature-item-title greennature-skin-title greennature-skin-border">
                                    <img src="{{ asset('./images/location.png') }}" class="location-pointer"
                                        alt="" width="80" height="80" />
                                    Where We Work
                                </h3>
                                <a class="greennature-item-title-link view-full-map" style="font-size: 15px;"
                                    target="_blank" href="{{ route('map') }}">View Full Map
                                </a>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="container">
                                <div class="three columns">
                                    <div
                                        ...
                                        <img src="{{ asset('upload/icon-4.png') }}" alt="" width="80"
                                            height="80" />
                                        <div class="greennature-skill-item-title" style="color: #3f3f3f;">7+
                                        </div>
                                        <div class="greennature-skill-item-caption" style="color:#3f3f3f;">
                                            Partnerships
                                        </div>
                                    </div>
                                </div>
                                <div class="three columns">
                                    <div
                                        ...
                                        <img src="{{ asset('upload/icon-5.png') }}" alt="" width="80"
                                            height="80" />
                                        <div class="greennature-skill-item-title" style="color:  #3f3f3f;">5+
                                        </div>
                                        <div class="greennature-skill-item-caption" style="color:  #3f3f3f;">
                                            Active Projects
                                        </div>
                                ...
                                <div class="three columns">
                                    <div
                                        class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2">
                                        <img src="{{ asset('upload/icon-2.png') }}" alt="" width="80"
                                            height="80" />
                                        <div class="greennature-skill-item-title" style="color: #3f3f3f;">40+
                                        </div>
                                        <div class="greennature-skill-item-caption" style="color: #3f3f3f;">
                                            Total Projects
                                        </div>
                                ...
                                <div class="three columns">
                                    <div
                                        class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2">
                                        <img src="{{ asset('upload/icon-6.png') }}" alt="" width="80"
                                            height="80" />
                                        <div class="greennature-skill-item-title" style="color:  #3f3f3f;">20+
                                        </div>
                                        <div class="greennature-skill-item-caption" style="color: #3f3f3f;">
                                            Districts
                                        </div>
                                                ...
                                                <div class="portfolio-classic-content">
                                                    <div style="text-align: center" class="reveal fade-bottom">
                                                        <a class="stunning-item-button large download-button-style"
                                                            href="{{ asset('storage/' . $publication->file_content) }}">View
                                                            Publication</a>
                                                    </div>
                                                    <div class="greennature-portfolio-info">
                                                        <div class="clear"></div>
                ...
                <div class="container">
                    <div class="three columns reveal fade-bottom">
                        <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                            ...
                            <a href="{{ route('career') }}"><img
                                    src="{{ asset('./images/Arannayk_icons/job (1).png') }}" alt=""
                    ...
                    <div class="three columns reveal fade-bottom">
                        <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                            style="margin-bottom: 70px">
                            <a href="{{ route('consultancy') }}"><img
                                    src="{{ asset('./images/Arannayk_icons/handshake.png') }}" alt=""
                                    width="80" height="80" /></a>
                            <div class="greennature-skill-item-title">
                    ...
                    <div class="three columns reveal fade-bottom">
                        <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                            style="margin-bottom: 70px">
                            <a href="{{ route('internship') }}"><img
                                    src="{{ asset('./images/Arannayk_icons/id-card (1).png') }}" alt=""
                                    width="80" height="80" /></a>
                            <div class="greennature-skill-item-title">
                    ...
                    <div class="three columns reveal fade-bottom">
                        <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                            style="margin-bottom: 70px">
                            <a href="{{ route('procurement') }}"><img
                                    src="{{ asset('./images/Arannayk_icons/trolley.png') }}" alt=""
                                    width="80" height="80" /></a>
                            <div class="greennature-skill-item-title">
