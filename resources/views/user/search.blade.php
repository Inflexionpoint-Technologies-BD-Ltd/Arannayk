                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    ...
                                                    <div class="portfolio-classic-content">
                                                        <h3 class="portfolio-title">
                                                            <a
                                                                href="{{ route('viewAchievement', $project->id) }}">{{ \Illuminate\Support\Str::words($project->title, 13, '...') }}</a>
                                                        </h3>
                                            ...
                                            <div
                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    ...
                                                    <div class="portfolio-classic-content">
                                                        <h3 class="portfolio-title">
                                                            <a
                                                                href="{{ route('viewProject', $project->id) }}">{{ \Illuminate\Support\Str::words($project->title, 13, '...') }}</a>
                                                        </h3>
                                                        <div class="greennature-portfolio-info">
                                                            <div class="portfolio-info portfolio-tag">
                                                                <span class="info-head greennature-title">
                                    ...
                                    <div class="greennature-item greennature-column-service-item greennature-type-1"
                                        ...
                                        <div class="column-service-content-wrapper">
                                            ...
                                            <a href="{{ route('services') }}">
                                                <h3 class="column-service-title hover-link-style">
                                                    {{ $service->title }}</h3>
                                            </a>
                                            ...
                                            <div
                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    ...
                                                    <div class="portfolio-classic-content">
                                                        <h3 class="portfolio-title">
                                                            <a
                                                                href="{{ route('viewBlog', $project->id) }}">{{ \Illuminate\Support\Str::words($project->title, 13, '...') }}</a>
                                                        </h3>
                                                        <div class="greennature-portfolio-info">
                                                            <div class="portfolio-info portfolio-tag">
                                                                <span class="info-head greennature-title">
                                            ...
                                            <div
                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    ...
                                                    <div class="portfolio-classic-content">
                                                        <h3 class="portfolio-title">
                                                            <a
                                                                href="{{ route('viewPress', $project->id) }}">{{ \Illuminate\Support\Str::words($project->title, 13, '...') }}</a>
                                                        </h3>
                                                        <div class="greennature-portfolio-info">
                                                            <div class="portfolio-info portfolio-tag">
                                                                <span class="info-head greennature-title">
