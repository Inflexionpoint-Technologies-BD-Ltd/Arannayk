                        ...
                        <div class="with-sidebar-container container">
                                        ...
                                        <div class="section-container container">
                                            <div class="blog-item-wrapper">
                                                <div class="blog-item-holder">
                                                    <div class="greennature-isotope" data-type="blog"
                                                        data-layout="fitRows">
                                                        <div class="clear"></div>
                                                                ...
                                                                <div class="greennature-ux greennature-blog-full-ux">
                                                                    <article id="post-862"
                                                                        ...
                                                                        <div class="greennature-standard-style">
                                                                            <div>
                                                                                <a> <img src="{{ asset('storage/' . $projects->image) }}"
                                                                                ...
                                                                                <div class="greennature-blog-content">
                                                                                    ...
                                                                                    <div class="greennature-blog-info"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <i
                                                                                                class="fa fa-tags"></i><a>{{ $projects->tag }}</a>
                                                                                        </div>
                                                                                        <div class="clear"></div>
                                                                                    </div>
                                                                                    <div class="clear">
                            ...
                            <div class="greennature-sidebar greennature-right-sidebar four columns">
                                <div class="greennature-item-start-content sidebar-right-item">
                                    <div id="search-3"
                                        class="widget widget_search greennature-item greennature-widget">
                                    ...
                                    <div id="gdlr-recent-portfolio-widget-2"
                                        ...
                                        <div class="widget-box-style">
                                            <h3 class="greennature-widget-title" style="color:#fff;">Project Details
                                            </h3>
                                            ...
                                            <div class="recent-post-widget">
                                                ...
                                                <div class="recent-post-widget-content">
                                                    <div class="blog-info blog-comment greennature-skin-info"><i
                                                            class="fa fa-location-arrow"></i><a>{{ $projects->location }}
                                                        </a>
                                                    </div>
                                    ...
                                    <div id="gdlr-recent-portfolio-widget-2"
                                        class="widget widget_gdlr-recent-portfolio-widget greennature-item greennature-widget">
                                        <div class="widget-box-style">
                                            <h3 class="greennature-widget-title" style="color:#fff;">Partners & Donors
                                            </h3>
                                    ...
                                    <div id="gdlr-recent-portfolio-widget-2"
                                        class="widget widget_gdlr-recent-portfolio-widget greennature-item greennature-widget">
                                        <div class="widget-box-style">
                                            <h3 class="greennature-widget-title" style="color:#fff;">SDG'S Achieved
                                            </h3>
                                            ...
                                            <div class="recent-post-widget">
                                                ...
                                                <div class="recent-post-widget-content">
                                                    ...
                                                    <div>
                                                        ...
                                                        @foreach ($svgs as $svg)
                                                            <img src="{{ asset('storage/' . $svg->image) }}"
                                    ...
                                    <div id="tag_cloud-2"
                                        ...
                                        <div class="tagcloud">
                                            ...
                                            <a href="{{ route('projects', $projects->tag) }}"
                                                ...
                                                style="font-size: 8pt;"
                                                aria-label="Animal (1 item)">{{ $projects->tag }}</a>
