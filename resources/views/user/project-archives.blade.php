                                                                        ...
                                                                        <article id="post-852"
                                                                            ...
                                                                            <div class="greennature-standard-style">
                                                                                <div
                                                                                    ...
                                                                                    <a href=""> <img
                                                                                            src="{{ asset('storage/' . $archive->image) }}"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <header class="post-header">
                                                                                        <h3
                                                                                            ...
                                                                                            <a
                                                                                                href="{{ route('viewArchivedProject', $archive->id) }}">{{ $archive->title }}</a>
                                                                                        </h3>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <i
                                                                                                    class="fa fa-heart"></i><a>{{ $archive->funded_by }}
                                                                                                </a></div>
                                                                                            <div
                                                                                                class="blog-info blog-comment greennature-skin-info">
                                                                                                <i
                                                                                                    class="fa fa-location-arrow"></i><a>{{ $archive->location }}</a>
                                                                                            </div>
                                                                                            <div
                                                                                                class="blog-info blog-author greennature-skin-info">
                                                                                                <i
                                                                                                    class="fa fa-tags"></i><a>{{ $archive->tag }}</a>
                                                                                            </div>
                                                ...
                                                <div class="recent-post-widget">
                                                    ...
                                                    <div class="recent-post-widget-content">
                                                        <div class="recent-post-widget-title"><a
                                                                href="#{{ $archive->title }}">{{ $archive->title }}</a>
                                                        </div>
                                    ...
                                    <div id="tag_cloud-2"
                                        ...
                                        <div class="tagcloud">
                                            @foreach ($tags as $archive)
                                                <a href="{{ route('archives', $archive->tag) }}"
                                                    class="tag-cloud-link tag-link-11 tag-link-position-1"
                                                    style="font-size: 8pt;"
                                                    aria-label="Animal (1 item)">{{ $archive->tag }}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
