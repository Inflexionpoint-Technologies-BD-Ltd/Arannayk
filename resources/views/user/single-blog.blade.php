                                            ...
                                            <div class="portfolio-item-holder  greennature-portfolio-column-3">
                                                <div class="greennature-isotope" data-type="portfolio"
                                                    ...
                                                    @if ($blogs != null)
                                                        ...
                                                        @if (
                                                            ($blogs->image_2 != null && pathinfo(asset('storage/' . $blogs->image_2), PATHINFO_EXTENSION) == 'jpg') ||
                                                                pathinfo(asset('storage/' . $blogs->image_2), PATHINFO_EXTENSION) == 'jpeg' ||
                                                                pathinfo(asset('storage/' . $blogs->image_2), PATHINFO_EXTENSION) == 'png')
                                                            <div class="six columns">
                                                                <div
                                                                    class="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <img src="{{ asset('storage/' . $blogs->image_2) }}"
                                                                                alt="" class="photos-style"
                                                                                style="height:300px" /><span
                                                                                class="portfolio-overlay">&nbsp;</span><a
                                                                                class="portfolio-overlay-icon"
                                                        ...
                                                        @if (
                                                            ($blogs->image_3 != null && pathinfo(asset('storage/' . $blogs->image_3), PATHINFO_EXTENSION) == 'jpg') ||
                                                                pathinfo(asset('storage/' . $blogs->image_3), PATHINFO_EXTENSION) == 'jpeg' ||
                                                                pathinfo(asset('storage/' . $blogs->image_3), PATHINFO_EXTENSION) == 'png')
                                                            <div class="six columns">
                                                                <div
                                                                    class="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="portfolio-thumbnail greennature-image">
                                                                            <img src="{{ asset('storage/' . $blogs->image_3) }}"
                                                                                alt="" class="photos-style"
                                                                                style="height:300px" /><span
                                                                                class="portfolio-overlay">&nbsp;</span><a
                                                                                class="portfolio-overlay-icon"
                                                        ...
                                                        @if (
                                                            ($blogs->image_4 != null && pathinfo(asset('storage/' . $blogs->image_4), PATHINFO_EXTENSION) == 'jpg') ||
                                                                pathinfo(asset('storage/' . $blogs->image_4), PATHINFO_EXTENSION) == 'jpeg' ||
                                                                pathinfo(asset('storage/' . $blogs->image_4), PATHINFO_EXTENSION) == 'png')
                                                            <div class="six columns">
                                                                <div
                                                                    class="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="portfolio-thumbnail greennature-image">
                                                                            <img src="{{ asset('storage/' . $blogs->image_4) }}"
                                                                                alt="" class="photos-style"
                                                                                style="height:300px" /><span
                                                                                class="portfolio-overlay">&nbsp;</span><a
                                                                                class="portfolio-overlay-icon"
                                                        ...
                                                        @if (
                                                            ($blogs->image_5 != null && pathinfo(asset('storage/' . $blogs->image_5), PATHINFO_EXTENSION) == 'jpg') ||
                                                                pathinfo(asset('storage/' . $blogs->image_5), PATHINFO_EXTENSION) == 'jpeg' ||
                                                                pathinfo(asset('storage/' . $blogs->image_5), PATHINFO_EXTENSION) == 'png')
                                                            <div class="six columns">
                                                                <div
                                                                    class="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="portfolio-thumbnail greennature-image">
                                                                            <img src="{{ asset('storage/' . $blogs->image_5) }}"
                                                                                alt="" class="photos-style"
                                                                                style="height:300px" /><span
                                                                                class="portfolio-overlay">&nbsp;</span><a
                                                                                class="portfolio-overlay-icon"
