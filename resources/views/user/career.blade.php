                        ...
                        <section id="content-section-1">
                            <div class="section-container container eight columns">
                                ...
                                <p style="margin-bottom:4rem; text-align: justify; margin-right:2rem; font-size:16px;">
                                    Are you passionate about conserving our forest and biodiversity for the future by
                                    making a difference?
                                    At Arannayk Foundation, we do not just dream of conserving forest for future, we are
                                            ...
                                            <div class="greennature-item greennature-accordion-item style-1"
                                                ...
                                                <div class="accordion-tab active pre-active">
                                                    <h4 class="accordion-title"><i
                                                            class="icon-minus"></i><span>{{ $career->title }}</span>
                                                    </h4>
                                                    <div class="accordion-content">
                                                        <p>{!! $career->description !!} </p>
                                                        <p>Deadline: {{ $career->deadline }}</p>
                                                        <a class="greennature-button small"
                                                            href="mailto: jobs@arannayk.org" target="_self"
                                                            style="color:#ffffff; background-color:#f38142; ">Apply</a>
                                                    </div>
                                                </div>
