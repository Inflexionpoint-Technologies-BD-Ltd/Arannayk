                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div id="carousel-{{ $photo->id }}"
                                                                                        class="carousel slide"
                                                                                        data-ride="carousel">
                                                                                        <div class="carousel-inner">
                                                                                            @foreach (\App\Photo::where('title', $title->title_first)->get() as $carousel_photo)
                                                                                                <div
                                                                                                    class="carousel-item {{ $photo->id == $carousel_photo->id ? 'active' : '' }}">
                                                                                                    <img class="d-block w-100"
                                                                                                        src="{{ asset('storage/' . $carousel_photo->image) }}"
                                                                                                        alt="{{ $carousel_photo->title }}">
                                                                                                    {{-- <div
                                                                                                        class="carousel-caption d-none d-md-block">
                                                                                                        <h5>{{ $carousel_photo->title }}
                                                                                                        </h5>
                                                                                                    </div> --}}
                                                                                                </div>
                                                                                            @endforeach
