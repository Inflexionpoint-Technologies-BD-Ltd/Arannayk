                            ...
                            @foreach ($tools as $tool)
                                <div class="with-sidebar-left twelve columns">
                                    <div class="with-sidebar-content twelve columns">
                                        <div
                                            class="greennature-item greennature-portfolio-style2 greennature-item-start-content">
                                            <div id="portfolio-76"
                                                class="post-76 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-environment portfolio_category-volunteer portfolio_tag-donation portfolio_tag-volunteer">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="greennature-ux greennature-classic-portfolio-ux">
                                                            <div class="portfolio-thumbnail"><img
                                                                    ...
                                                                    alt="" class="tools-image-style" /><span
                                                ...
                                                <div class="greennature-portfolio-content">
                                                    <div class="greennature-portfolio-info">
                                                        ...
                                                        <div class="content">
                                                            <div class="portfolio-info portfolio-clients"><span
                                                                    class="info-head greennature-title">Author
                                                                </span>{{ $tool->author }}</div>
                                                            <div class="portfolio-info portfolio-skills"><span
                                                                    class="info-head greennature-title">Publication
                                                                    Date </span>{{ $tool->publication_date }}</div>
                                                            <div class="portfolio-info portfolio-website"><span
                                                                    class="info-head greennature-title">Link </span><a
                                                                    href="{{ $tool->link }}"
                                                                    target="_blank">{{ $tool->link }}</a></div>
                                                            <div class="clear"></div>
