                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <article id="post-852"
                                                                            ...
                                                                            <div class="greennature-standard-style">
                                                                                <div
                                                                                    class="greennature-blog-thumbnail">
                                                                                    <a href=""> <img
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <header class="post-header">
                                                                                        <h3
                                                                                            class="greennature-blog-title">
                                                                                            <a>{{ $project->title }}</a>
                                                                                        </h3>

                                                                                        <div
                                                                                            class="greennature-blog-info">
                                                                                            ...
                                                                                            <div
                                                                                                class="blog-info blog-comment greennature-skin-info">
                                                                                                <i
                                                                                                    class="fa fa-location-arrow"></i><a>{{ $project->location }}
                                                                                                </a></div>
                                                                                    ...
                                                                                    <div
                                                                                        class="greennature-blog-content">
                                                                                        Major Achievements:
                            ...
                            <div class="greennature-sidebar greennature-right-sidebar four columns">
                                <div class="greennature-item-start-content sidebar-right-item">
                                    ...
                                    <div id="gdlr-recent-portfolio-widget-2"
                                        ...
                                        <h3 class="greennature-widget-title">Our Projects</h3>
                                        <div class="clear"></div>
                                        <div class="greennature-recent-port-widget">
                                                ...
                                                <div class="recent-post-widget">
                                                    ...
                                                    <div class="recent-post-widget-content">
                                                        <div class="recent-post-widget-title"><a
                                                                href="#{{ $project->title }}">{{ \Illuminate\Support\Str::words($project->title, 13, '...') }}</a>
                                                        </div>
                                            ...
                                            @foreach ($widgets_archives as $project)
                                                <div class="recent-post-widget">
                                                    <div class="recent-post-widget-thumbnail">
                                                        <a href=""><img
                                                                src="{{ asset('storage/' . $project->image) }}"
                                        ...
                                        <div class="tagcloud">
                                            @foreach ($projects as $project)
                                                <a href="#{{ $project->title }}"
                                                    ...
                                                    style="font-size: 8pt;"
                                                    aria-label="Animal (1 item)">{{ $project->tag }}</a>
                                            @endforeach
                                            @foreach ($archives as $project)
                                                <a href="#{{ $project->title }}"
                                                    class="tag-cloud-link tag-link-11 tag-link-position-1"
