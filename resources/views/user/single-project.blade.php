...
<div class="body-wrapper float-menu" data-home="https://demo.goodlayers.com/greennature/">
    ...
    <div class="greennature-page-title-wrapper header-style-5-title-wrapper">
        ...
        <div class="greennature-page-title-container container">
            <span class="greennature-page-caption">What We Do</span>
                                                        ...
                                                        <div class="greennature-ux greennature-blog-full-ux">
                                                            <article id="post-862" class="post-862 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-fit-row tag-blog tag-link tag-news">
                                                                <div class="greennature-standard-style">
                                                                    <div>
                                                                        <a> <img src="{{ asset('storage/'.$archives->image)  }}" class="press-release-image" alt=""  /></a>
                                                                    </div>

                                                                    <div class="blog-content-wrapper">
                                                                        <header class="post-header">
                                                                            <h3 class="greennature-blog-title"><a>{{ $archives->title }}</a></h3>
                                                                        ...
                                                                        <div class="greennature-blog-content">
                                                                            ...
                                                                            <div class="greennature-blog-info" style="margin-top:2rem;">
                                                                                <div class="blog-info blog-author greennature-skin-info"><i class="fa fa-tags"></i><a>{{ $archives->tag }}</a></div>
                                                                                <div class="clear"></div>
                                                                            </div>
                                                                            <div class="clear">
                                                                            </div>
