                                    ...
                                    <div class="greennature-isotope" data-type="portfolio" data-layout="fitRows">
                                        ...
                                        @if (request()->query('q') == 1)
                                            ...
                                            <p>Arannayk Foundation, also known as the Bangladesh Tropical Forest
                                                ...
                                                <a href="www.arannaykfoundation.org">www.arannaykfoundation.org</a>
                                                (the
                                                website).
                                                ...
                                                These Terms and Conditions apply separately to each single donation that
                                                you
                                                make. By confirming on
                                                the Website that you wish to donate you agree to these terms and
                                                conditions
                                                for that donation.
                                            </p>
                                            ...
                                            <p>We will use your donation in line with our stated charitable objectives.
                                                All
                                                payments through the Website
                                                are to be made by card or mobile financial transaction or internet
                                                banking
                                                applications.
                                                ...
                                                proceed with your donation, you authorize our payment service provider
                                                to
                                                request funds from your credit,
                                                debit card provider and mobile financial transaction and internet
                                                banking
                                                service provider.
                                            </p>
                                            ...
                                            <p>Before we can process your donation, you must provide us with the
                                                necessary
                                                information such as your
                                                name, address, email address, and contact number. We will use this data
                                                to
                                                process the donation, so it is
                                                important that you make sure to provide us with the correct info.
                                                <br><br>
                                                When you submit your payment information, this data is sent securely to
                                                our
                                                payment service provider.
                                                Be sure to read their terms and conditions before donating so that you
                                                feel
                                                comfortable with how they will
                                                handle your personal data.
                                                <br><br>
                                                We will not disclose any of your personal details to any other third
                                                party
                                                except those mentioned in our
                                                Privacy Policy. By accepting these Donation Payment Terms &amp;
                                                Conditions,
                                            ...
                                            <br>
                                            <h4>(5) General</h4>
                                            <p>We reserve the right to amend these Donation Payment Terms and Conditions
                                                at any time.
                                            </p>
                                        @elseif(request()->query('q') == 2)
