            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title') is-invalid @enderror" value="{{ $mission->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter Content">{{ $mission->content }}</textarea>
                </div>
...
{{--                <div class="form-group">--}}
{{--                    <label for="exampleInputEmail1">Enter color Hex code</label>--}}
{{--                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"--}}
{{--                           placeholder="Enter content" name="color_title"--}}
{{--                           class="form-control @error('color_title') is-invalid @enderror" value="{{ $mission->color_title }}">--}}
{{--                </div>--}}
