...
@section('content')
    <h4>Edit Consultancy Contents</h4>
    <hr>

    <div>
        <form action="{{ route('consultancy.update',$consultancy->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            @method('put')
            <form>
                ...
                {{--                <div class="form-group">--}}
                {{--                    <label for="exampleFormControlFile1">Enter Image 2 [Optional]</label>--}}
                ...
                {{--                <div class="form-group">--}}
                {{--                    <label for="exampleFormControlFile1">Enter Image 3 [Optional]</label>--}}
                ...
                <div class="form-group">
                    ...
                    {{--                           class="form-control @error('content') is-invalid @enderror" value="{{ $consultancy->content }}">--}}

                    <textarea type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                              placeholder="Enter content" name="content"
                              class="form-control @error('content') is-invalid @enderror">{{ $consultancy->content }}</textarea>
                </div>
