            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title') is-invalid @enderror" value="{{ $achievement->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{!! $achievement->content !!}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('date') is-invalid @enderror" value="{{ $achievement->date }}">
                </div>
