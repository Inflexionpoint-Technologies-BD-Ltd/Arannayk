            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title') is-invalid @enderror" value="{{ $tool->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('author') is-invalid @enderror" value="{{ $tool->author }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="exampleInputEmail1" aria-describedby="emailHelp"
                           placeholder="" name="publication_date"
                           class="form-control @error('publication_date') is-invalid @enderror"
                           value="{{ $tool->publication_date }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('link') is-invalid @enderror" value="{{ $tool->link }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $tool->content }}</textarea>
                </div>
