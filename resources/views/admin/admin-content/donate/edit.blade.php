            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title') is-invalid @enderror" value="{{ $donate->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $donate->content }}</textarea>
                </div>
