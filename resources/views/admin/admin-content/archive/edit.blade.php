            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title') is-invalid @enderror" value="{{ $archive->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('location') is-invalid @enderror" value="{{ $archive->location }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="achievement" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{!! $archive->achievement !!}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('date') is-invalid @enderror" value="{{ $archive->date }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('funded_by') is-invalid @enderror" value="{{ $archive->funded_by }}">
                </div>
