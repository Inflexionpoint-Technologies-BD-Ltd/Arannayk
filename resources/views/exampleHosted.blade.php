    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <p>There is no limit to donate an amount. If you would like to donate a large amount and need help in
                    the
                ...
                <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="amount" id="total_amount" placeholder=""
                            value="" required min="500" max="500000">
                        <div class="invalid-feedback">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="save-info">I HAVE READ AND AGREE TO THE WEBSITE'S <a
                                href="{{ route('terms', ['q' => 1]) }}">TERMS AND CONDITIONS</a>, <a
                                href="{{ route('terms', ['q' => 2]) }}">PRIVACY
        ...
        <footer class="my-5 pt-5 text-muted text-center text-small">
            <p class="mb-1">&copy; Arannayk Foundation</p>
